...
pub struct AssemblerConfig {
    // if true, parse 0xBNNN as PC = NNN + VN rather than PC = NNN + V0
    pub jump_register_quirk: bool,
}

impl AssemblerConfig {
    pub fn new() -> Self {
        Self {
            jump_register_quirk: false,
        }
    }
}
...
impl Assembler {
    pub fn new() -> Self {
        Self {
            config: AssemblerConfig::new(),
        }
    }

    pub fn assemble(&self, instruction: &Instruction) -> Result<OpCode> {
    ...
    pub fn disassemble(&self, opcode: OpCode) -> Result<Instruction> {
